...
const ConsentFormHeader = ({ currentRegion, regionDetected, isResuming }: ConsentFormHeaderProps) => {
  console.log('ConsentFormHeader - Using new Mia logo: /mia-consent-offline-form/lovable-uploads/2741077b-1d2b-4fa2-9829-1d43a1a54427.png');
    ...
    <div className="bg-[#ef4805] p-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white p-3 inline-block rounded-lg">
          <img 
            src="/mia-consent-offline-form/lovable-uploads/2741077b-1d2b-4fa2-9829-1d43a1a54427.png" 
            alt="Mia Healthcare"
